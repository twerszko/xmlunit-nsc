...
public class DOMDifferenceEngineTest extends AbstractDifferenceEngineTest {
	...
	public void compareNodesOfDifferentType() {
		...
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(doc.createElement("x"), new XPathContext(), doc.createComment("x"), new XPathContext()));
	...
	public void compareNodesWithoutNS() {
		...
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(doc.createElement("x"), new XPathContext(), doc.createElement("x"), new XPathContext()));
	...
	public void compareNodesDifferentNS() {
		...
		d.addDifferenceListener(ex);
		d.setDifferenceEvaluator(DifferenceEvaluators.DefaultStopWhenDifferent);
		assertEquals(ComparisonResult.CRITICAL, d.compareNodes(doc.createElementNS("x", "y"), new XPathContext(),
		        doc.createElementNS("z", "y"), new XPathContext()));
		assertEquals(1, ex.invoked);
	}
	...
	public void compareNodesDifferentPrefix() {
		...
		assertEquals(ComparisonResult.CRITICAL, d.compareNodes(doc.createElementNS("x", "x:y"), new XPathContext(),
	...
	public void compareCharacterData() {
			...
			public ComparisonResult evaluate(Comparison comparison, ComparisonResult outcome) {
				if (comparison.getType() == ComparisonType.NODE_TYPE) {
					if (outcome == ComparisonResult.EQUAL
					        || (comparison.getControlDetails().getTarget() instanceof CharacterData && comparison
					                .getTestDetails().getTarget() instanceof CharacterData)) {
						return ComparisonResult.EQUAL;
					}
				}
		...
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooComment, new XPathContext(), fooComment, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooComment, new XPathContext(), barComment, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL, d.compareNodes(fooText, new XPathContext(), fooText, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooText, new XPathContext(), barText, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooCDATASection, new XPathContext(), fooCDATASection, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooCDATASection, new XPathContext(), barCDATASection, new XPathContext()));

		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooComment, new XPathContext(), fooText, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooComment, new XPathContext(), barText, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooComment, new XPathContext(), fooCDATASection, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooComment, new XPathContext(), barCDATASection, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooText, new XPathContext(), fooComment, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooText, new XPathContext(), barComment, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooText, new XPathContext(), fooCDATASection, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooText, new XPathContext(), barCDATASection, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooCDATASection, new XPathContext(), fooText, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooCDATASection, new XPathContext(), barText, new XPathContext()));
		assertEquals(ComparisonResult.EQUAL,
		        d.compareNodes(fooCDATASection, new XPathContext(), fooComment, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL,
		        d.compareNodes(fooCDATASection, new XPathContext(), barComment, new XPathContext()));
	...
	public void compareProcessingInstructions() {
		...
		assertEquals(ComparisonResult.EQUAL, d.compareNodes(foo1, new XPathContext(), foo1, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL, d.compareNodes(foo1, new XPathContext(), bar1, new XPathContext()));
		assertEquals(1, ex.invoked);
		...
		assertEquals(ComparisonResult.EQUAL, d.compareNodes(foo1, new XPathContext(), foo1, new XPathContext()));
		assertEquals(ComparisonResult.CRITICAL, d.compareNodes(foo1, new XPathContext(), foo2, new XPathContext()));
		assertEquals(1, ex.invoked);
	}
