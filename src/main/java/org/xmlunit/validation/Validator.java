...
/**
 * Validates a piece of XML against a schema given in a supported language or
 * the defintion of such a schema itself.
 */
public abstract class Validator {
    ...
    /**
     * The URI (or for example the System ID in case of a DTD) that identifies
     * the schema to validate or use during validation.
     */
     ...
     *             if the language's implementation doesn't support schema
     *             validation
     */
