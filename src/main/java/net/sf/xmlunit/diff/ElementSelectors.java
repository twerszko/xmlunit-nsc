...
public final class ElementSelectors {
	...
	/**
	 * Always returns true, i.e. each element can be compared to each other
	 * element.
	 * 
	 * <p>
	...
	/**
	 * Elements with the same local name (and namespace URI - if any) can be
	 * compared.
	 */
	...
	/**
	 * Elements with the same local name (and namespace URI - if any) and nested
	 * text (if any) can be compared.
	 */
	...
	/**
	 * Elements with the same local name (and namespace URI - if any) and
	 * attribute values for the given attribute names can be compared.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Namespace URIs of attributes are those of the attributes on the control
	 * element or the null namespace if the don't exist.
	 * </p>
	 */
	public static ElementSelector
		...
		final HashSet<String> as = new HashSet<String>(Arrays.asList(attribs));
	...
	/**
	 * Elements with the same local name (and namespace URI - if any) and
	 * attribute values for all attributes can be compared.
	 */
	...
	/**
	 * Elements with the same local name (and namespace URI - if any) and child
	 * elements and nested text at each level (if any) can be compared.
	 */
